...
import dev.mickael.adventofcode.day11.SeatingSystem.Seat;
...
public class SeatingSystemTest {
  ...
  void testParser() {
    ...
    var seating = SeatingSystem.fromInput(input).getGrid();
  ...
  void testExampleFile() throws URISyntaxException, IOException {
    ...
    var seating = SeatingSystem.fromInput(grid);
    while (seating.next())
      ;

    assertEquals(37, seating.numEmpty());
  }
  ...
  void testInputFile() throws URISyntaxException, IOException {
    ...
    assertEquals(2319, seating.numEmpty());
  }
}
